...
>
> Droidify-dh is a personal fork of [Droid-ify](https://github.com/Iamlooker/Droid-ify). A large share of the changes specific to this fork are written with AI assistance. Even thought I use this fork daily without any problems, it does not mean that it will work for you. Review the code yourself before trusting it, and do not assume the same quality, security review, or stability as upstream Droid-ify. 
...
> [!Note]
> **Upstream and credit:** 
> This fork stands entirely on the work of [LooKeR](https://github.com/Iamlooker) and the Droid-ify contributors. 
> Droid-ify is an excellent, clutter-free F-Droid client and all credit for the app belongs to them — this fork only layers one extra installer on top. 
> Please support and follow [the original project](https://github.com/Iamlooker/Droid-ify).
